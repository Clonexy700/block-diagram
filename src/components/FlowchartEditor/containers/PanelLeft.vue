...
<template>
  <CardBox class="panel-left" placement="left" position="right" :width="250" @expand="toggleHandler">
    <CardItem :title="$t('Блоки')" :enableFold="true" :bold="true">
      <NodeElement
    ...
    <CardItem :title="$t('Карта схемы')" :enableFold="true" :bold="true" style="position: absolute;bottom:0;left:0;width:100%;">
      <Navigator></Navigator>
    </CardItem>
  </CardBox>
</template>
